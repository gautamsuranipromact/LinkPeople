...
import 'package:link_people/screens/SettingsScreen.dart';
...
Widget drawerComponent(BuildContext context, onTap) {
  return Container(
    padding: EdgeInsets.only(top: context.statusBarHeight, left: 12, right: 16, bottom: 16),
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CircleAvatar(backgroundImage: AssetImage(ic_profile), backgroundColor: context.cardColor, maxRadius: 50),
                    SizedBox(height: 10),
                    ...
                    .map(
                      (e) => Padding(
                        ...
                        child: GestureDetector(
                            ...
                            child: Text("# " + e.text.toString(), style: primaryTextStyle(), textAlign: TextAlign.start)),
                      ),
                    )
                    .toList()),
            TextButton(
                onPressed: () {
                  finish(context);
                  GroupScreen().launch(context, pageRouteAnimation: PageRouteAnimation.Slide);
                },
                child: Text('Groups', style: boldTextStyle())),
            TextButton(
                onPressed: () {
                  finish(context);
                  EventsScreen().launch(context, pageRouteAnimation: PageRouteAnimation.Slide);
                },
        ...
        Column(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                finish(context);
                PremiumScreen().launch(context, pageRouteAnimation: PageRouteAnimation.Slide);
              },
              child: Row(
                children: [
                  Icon(Ionicons.square, color: tanColor),
                  SizedBox(width: 6),
                  Text('Try Premium For Free', style: boldTextStyle(color: primaryColor)),
                ],
              ),
            ),
            TextButton(
              onPressed: () {
                finish(context);
                SettingsScreen().launch(context, pageRouteAnimation: PageRouteAnimation.Slide);
              },
              child: Row(
                children: [
