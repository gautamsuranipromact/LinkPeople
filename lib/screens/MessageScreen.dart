...
class _MessageScreenState extends State<MessageScreen> {
  bool isFilter = false;
  List<String> filterList = ['All', 'Unread', 'My Connections', 'InMail', 'Archived', 'Spam'];
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20),
                            Text('Message request ibox', style: secondaryTextStyle()),
                            SizedBox(height: 20),
                            Text('Set away message', style: secondaryTextStyle()),
                          ],
                        ),
                      );
                    });
              },
              icon: Icon(Feather.more_vertical, color: textSecondaryColorGlobal)),
          IconButton(
              onPressed: () {
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text('Search messages', style: secondaryTextStyle())),
                  GestureDetector(
                      onTap: () {
                        isFilter = !isFilter;
                        setState(() {});
                      },
                      child: Icon(MaterialCommunityIcons.filter_variant, color: textSecondaryColorGlobal))
                ],
              ),
            ),
            Divider(thickness: 1),
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => Container(
                    ...
                    decoration: BoxDecoration(borderRadius: radius(16), border: Border.all(width: 0.3)),
            ...
            Padding(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CircleAvatar(backgroundColor: context.cardColor, backgroundImage: AssetImage(ic_woman6), maxRadius: 30),
                  SizedBox(width: 8),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Text('Hi Akansha bhadani, we both studied engineering collage ', style: secondaryTextStyle()),
                      ],
                    ),
                  ),
