    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          component(
              context, "Site preferences", 'Manage your Find My CoFounder experience',
              color: context.dividerColor,
              size: 20,
              subSize: 16,
              textColor: textPrimaryColorGlobal,
          ...
          component(context, "Autoplay video",
              'Choose to autoplay videos on Find My CoFounder '),
          ...
          component(context, "Upgrade for Free",
              "Services you've connected to your Find My CoFounder account"),
          component(context, "View purchase history",
              "See your previous purchases and translations on Find My CoFounder"),
          component(context, "Account management",
              "Service you've connected your Find My CoFounder account",
              color: context.dividerColor,
              size: 20,
              subSize: 16,
              textColor: textPrimaryColorGlobal,
          ...
          component(context, 'Microsoft',
              "View Microsoft account you've connected to your Find My CoFounder account"),
          component(context, "Twitter setting",
              "Manage Twitter in for on your Find My CoFounder account"),
          component(
              context, "Account management", "Control your Find My CoFounder account",
              color: context.dividerColor,
              size: 20,
              subSize: 16,
              textColor: textPrimaryColorGlobal,
