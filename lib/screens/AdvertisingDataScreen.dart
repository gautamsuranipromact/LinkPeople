      ...
      body: ListView(
        children: [
          ...
          component(context, "Interest Categories",
              'See more relevant ads, such as job ads,based on your and similar member activities on LinkPeople and bing'),
          component(context, "Data collected on LinkPeople",
              "Choose what type of data you'd like LinkPeople to use to show you more relevant",
              color: context.dividerColor,
              size: 20,
              subSize: 16,
              textColor: textPrimaryColorGlobal,
