          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text('Start saving jobs you are interested in', style: boldTextStyle(size: 20)),
                SizedBox(height: 8),
                Text("Once jobs are saved, you'll find them here", style: secondaryTextStyle()),
                SizedBox(height: 8),
                Container(
                  height: 30,
                  ...
                  child: Text('Browse jobs for me', style: primaryTextStyle(color: primaryColor)),
                )
              ],
            ),
          ),
