...
class _CommunicationsScreenState extends State<CommunicationsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          component(context, "How you get your notifications",
          ...
          component(context, "Who can reach you",
              ...
              textColor: textPrimaryColorGlobal,
              isIcon: false),
          component(context, "Invitations to connect",
              "Choose who can connect with you"),
          component(context, "Invitations from you network",
          ...
          component(context, "Who can reach you",
              ...
              textColor: textPrimaryColorGlobal,
              isIcon: false),
          component(context, "Read receipts and trying indicators",
              'Turn on read receipts and trying indicators'),
          component(context, "Messaging suggestions",
              "Choose if you want suggestions when messaging"),
          component(context, "Message nudges",
              "Choose if you want to receive reminders about messages you haven't responded"),
        ],
      ),
    );
  }
