import 'package:link_people/models/common_models/content.dart';
  ...
  factory Embedded.fromJson(Map<String, dynamic> json) {
    return Embedded(
      author: json['author'] != null
          ...
          : null,
      featuredMedia: json['wp:featuredmedia'] != null
          ? (json['wp:featuredmedia'] as List)
              .map((i) => FeaturedMedia.fromJson(i))
              .toList()
          : null,
    );
  }
...
class Author {
  ...
  factory Author.fromJson(Map<String, dynamic> json) {
    return Author(
      acf: json['acf'] != null
          ? (json['acf'] as List).map((i) => i.fromJson(i)).toList()
          : null,
...
class FeaturedMedia {
  ...
  factory FeaturedMedia.fromJson(Map<String, dynamic> json) {
    return FeaturedMedia(
      ...
      author: json['author'],
      caption:
          json['caption'] != null ? Content.fromJson(json['caption']) : null,
      date: json['date'],
      id: json['id'],
      link: json['link'],
