import 'package:link_people/models/common_models/links.dart';

import 'common_models/avatar_urls.dart';
...
class Value {
  ...
  factory Value.fromJson(Map<String, dynamic> json) {
    return Value(
      ...
      unserialized: json['unserialized'] != null
          ? new List<String>.from(json['unserialized'])
          : null,
    );
  }
